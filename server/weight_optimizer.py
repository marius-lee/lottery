...
# 策略族分组 — 对齐项目实际方法名 (ensemble_aggregator METHOD_REGISTRY)
FAMILIES = {
    "G1_作者族": ["吴明·5期重号", "吴明·9期冷号反转", "吴明·6区间排除", "吴明·极值优先"],
    "G2_通道族": ["彭浩·MA双通道"],
    "G3_位置族": ["蒋加林·排列型", "张委铭·围号选号", "李志林·八招定胆"],
    "G4_尾码族": ["刘大军·定尾选号", "刘大军·重合码"],
    "G5_趋势族": ["李相春·趋势分析"],
    "G6_统计族": ["频率基线", "贝叶斯偏差"],
}
...
# 冷启动: 每个方法初始5次测试, 均值等于理论基线
COLD_START_SEEDS = {
    "频率基线": (5, RED_BASELINE / 6),
}
