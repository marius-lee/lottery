...
window.checkJackpot = window.checkJackpot || function(){};
window.switchArsenalTab = window.switchArsenalTab || function(){};
window.toggleTraditionalFilters = function(){};
window.toggleAutoKelly = window.toggleAutoKelly || function(){};
window.toggleMonitorDetail = window.toggleMonitorDetail || function(){};
