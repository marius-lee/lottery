...
window._showWeierPanel = function(){
  ...
  var clsTag = function(o){ return o<=10?'<span style="color:#10B981;font-size:10px;">热</span>':o<=18?'<span style="color:#FBBF24;font-size:10px;">温</span>':'<span style="color:#EF4444;font-size:10px;">冷</span>'; };

  function render(data){
    var h = '<div class="weier-container">';
    h += '<div style="display:flex;gap:8px;margin-bottom:12px;">';
    h += '<button class="btn btn-draw" onclick="window._runWeierFilter()" style="font-size:12px;padding:6px 16px;">开始过滤</button>';
    h += '<button class="btn btn-save" onclick="window._clearWeier()" style="font-size:12px;padding:6px 16px;background:#64748B;">清除选择</button>';
    h += '<span id="weierStatus" style="font-size:11px;color:#94A3B8;align-self:center;"></span></div>';
